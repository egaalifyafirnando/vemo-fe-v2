        ...
        <div class="row justify-content-center">
            <div class="col-md-6">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" v-model="user.name" class="form-control rounded-pill list-form-item" placeholder="Full Name" />
                                    </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="password" v-model="user.password_confirmation" class="form-control rounded-pill list-form-item"
                                            placeholder="Konfirmasi Password" />
                                    </div>
                                </div>
                            </div>
                            <button type="submit" class="btn btn-light btn-md mt-3 btn-block shadow-md text-white rounded-pill" style="background: #cf1b1b">
                                REGISTER
                            </button>
                        </form>
                    </div>
                ...
                <div class="register mt-3 text-center">
                    <p>Sudah punya akun ? <router-link v-bind:to="{ name: 'login' }">Login Disini !</router-link>
                    </p>
                </div>
            </div>
        </div>
