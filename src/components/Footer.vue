        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-5 mb-4">
                    ...
                    <p>Toko fashion online terpercaya di Indonesia. Dapatkan produk dengan harga termurah! Belanja sekarang.</p>
                    <div class="social">
                        <a href="#" class="mr-4" style="color: #CF1B1B"> <i class="fab fa-facebook fa-2x"></i></a>
                        <a href="#" class="mr-4" style="color: #CF1B1B"> <i class="fab fa-twitter fa-2x"></i></a>
                        <a href="#" class="mr-4" style="color: #CF1B1B"> <i class="fab fa-instagram fa-2x"></i></a>
                        <a href="#" style="color: #CF1B1B"> <i class="fab fa-youtube fa-2x"></i></a>
                    </div>
                </div>
            ...
            <div class="row text-center mt-3 pb-3">
                <div class="col-md-12">
                    <hr />
                    &copy; <strong>Vemo Store</strong> 2022<br />
                    made with <i class="fa fa-heart"></i> by
                    <a href="http://instagram.com/egaalfy_/" target="_blank" rel="noopener noreferrer" class="font-weight-bold" style="color: #CF1B1B">eaf.dev</a>
                </div>
            </div>
        </div>
    </footer>
